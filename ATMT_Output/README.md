...
1. **Install the plugin** — find ATMT on the Agency plugin catalog: <https://vigilant-adventure-v9qpqwn.pages.github.io/all/#plugins?sort=mostLiked> (Microsoft EMU) and install it into your Copilot / Claude CLI.
